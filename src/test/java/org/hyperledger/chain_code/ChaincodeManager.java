...
import org.hyperledger.chain_code.Chaincode;
import org.hyperledger.chain_code.Orderers;
import org.hyperledger.chain_code.Peers;
...
public class ChaincodeManager {
    ...
    public ChaincodeManager(FabricConfig fabricConfig)
            throws CryptoException, InvalidArgumentException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException, IOException, TransactionException,Exception {

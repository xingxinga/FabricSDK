...
public class InvalidProtocolBufferRuntimeException extends RuntimeException {
    ...
    public InvalidProtocolBufferRuntimeException(String message, InvalidProtocolBufferException parent) {
        super(message, parent);
    }

    public InvalidProtocolBufferRuntimeException(InvalidProtocolBufferException parent) {
        super(parent);
    }
